...
from app.models import (ProdutoEPI, GradeEPI, Empresa, 
                        Funcionarios, Departamento, Cargos,
                        Users, Groups, RegistrosEPI, RegistroEntradas,
                        EstoqueEPI, EstoqueGrade, GradeEPI)
tipo = db.Model
